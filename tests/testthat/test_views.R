...
# from DataExplorer github code for tests at
# https://github.com/boxuancui/DataExplorer/blob/master/tests/testthat/test-split-columns.r
# since we import the functions as well
